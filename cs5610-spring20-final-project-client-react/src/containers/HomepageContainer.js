          ...
          this.setState(
            {
              ...
              favoriteMovies: currUser.favoriteMovies.slice(0, favoriteMoviesDisplayNum)
            })
        });
    } else {
        ...
        <div className="container-fluid">
          ...
          <div className="row">
            ...
            <div className="mt-3 col-sm-12 col-md-6">
              ...
              <div>
                <h4 className="pt-3 pb-2 text-center border-bottom">Your favorite movies</h4>
                {
                  this.state.favoriteMovies && this.state.favoriteMovies.map(
                    movie =>
                      <MovieItemComponent
                        movie={movie}
                        key={movie.id}/>
